...
#获取资产正式卖出api结果
def getAssetsSold(assetsBagNo,productType,sourceSystem,finishBy,finishDate,bagScale,access_token,requestId): 
    url = config.url['getAssetsSold'] + '?access_token='+access_token+'&request_id='+requestId+'&assetsBagNo='+assetsBagNo+'&sourceSystem='+sourceSystem+'&productType='+productType+'&finishBy='+finishBy+'&finishDate='+finishDate+'&bagScale='+bagScale
...
#获取资产增删api结果
def getAssetsAdjust(assetsBagNo,sourceSystem,addNumber,delNumber,updatedBy,access_token,requestId): 
    url = config.url['getAssetsAdjust'] + '?access_token='+access_token+'&request_id='+requestId+'&assetsBagNo='+assetsBagNo+'&sourceSystem='+sourceSystem+'&addNumber='+addNumber+'&delNumber='+delNumber+'&updatedBy='+updatedBy 
