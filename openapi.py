...
#获取资产对付操作api结果
def getAssetsPlanPay(paymentId,trustCode,trustName,paymentAmount,payDate,receiverAccount,receiverBank,receiverName,isRegulated,paymentOrganization,access_token,requestId,paymentAccount,sourceSystem,productType,updatedBy): 
    ...
    re = json.loads(str(requests.get(url))) 
    #tools.log(re,'info'); 
    return re; 
